...
static bool _categories_loading = false;
...
void _on_province_form_field_click(){
  ...
  print('province focus $_province_focus');
  if(_province_focus_active){
    setState((){
      clicked = true;
    });
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            new FlatButton(
              ...
              print('province focus node $_province_focus');
...
void _on_business_category_form_field_click(){
  ...
  if(_business_category_focus_active){
    ...
    // if(Government_categories.isEmpty)
    //   get_all_cats();
    ...
    showDialog(
      ...
      context: _scaffold_key.currentContext,
      builder: (BuildContext context){
        //return set_up_categories_dialog();
        return AlertDialog(
...
_form_view() => Container(
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: _is_in_async_call ? Center(child: CircularProgressIndicator(),) : _form_view(),
    );
  }

RaisedButton submit_advert_button(){
  return RaisedButton(
